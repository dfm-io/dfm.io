---
Title: Extending JAX with custom C++ and CUDA code
Date: 2021-01-11
Slug: extending-jax
Math: true
---

> The primary version of this post can be found on GitHub: [dfm/extending-jax](https://github.com/dfm/extending-jax)
